...
fn commit_tree(args: &[String]) {
    ...
    let commit_hash = write_new_git_commit(tree_hash, message, parent_hash);
    println!("{}", commit_hash);
}
...
// Create a new commit object
fn write_new_git_commit(tree_hash: &str, message: &str, parent_hash: &str) -> String {
    let hardcoded_author_name = "Ross Heaney ";
    let hardcoded_author_email = "test@gmail.com";
